...
**Escopo**: Implementar o bloco Scout e conectá-lo ao Master-Recruiter.
...
**Saídas**:
- Retornar resultados ao Master-Recruiter via Response Envelope (Master-Recruiter salva em `data/job-search-results.md`)
...
### 3. Conectar `spawn_agent` no Master-Recruiter para despachar o Scout

- Quando o usuário digitar "A", o Master-Recruiter deve construir o envelope de despacho
...
Usuário seleciona A no menu
        │
        ▼
Master-Recruiter constrói envelope de despacho para Scout
        │
        ▼
...
Scout retorna envelope de resposta com até 5 vagas
        │
        ▼
Master-Recruiter salva em data/job-search-results.md → exibe ao usuário → retorna ao menu
```
